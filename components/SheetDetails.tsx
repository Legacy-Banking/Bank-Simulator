    ...
    <div className="bg-white p-4 rounded-lg shadow-2xl max-w-md mx-auto">
      ...
      <div className="grid grid-cols-2 gap-4 items-start mt-1 mb-2">
        <div>
          ...
          <p className="text-xs"> Invoice Date: <span className="text-xs font-medium">{formatDateTime(bill.created_at!)}</span></p>
        </div>
        <div className="text-xs text-right">
          <h2 className="font-semibold text-base mb-1 text-blue-800">{biller.name}</h2>
