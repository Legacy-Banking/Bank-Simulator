...
const AdminSideBar = ({ activePage, setActivePage }: { activePage: string, setActivePage: (page: string) => void }) => {
    return (
        ...
        className="sticky top-0 w-64 min-h-screen pt-28 bg-white z-10">
            <div className='px-4 space-y-8'>
                ...
                <AdminNavLink page={'content-management-system'} activePage={activePage} setActivePage={setActivePage}>Content Management</AdminNavLink>
